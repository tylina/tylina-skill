...
`statements.typ` owns the visual statement system while `main.typ` owns mathematical content.
Replace the sample identity with the user's actual statement and proof. Do not change assumptions
or claims merely to make the proof close.
