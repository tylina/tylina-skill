...
| Academic thesis or monograph | `thesis` plus institution/language | Institution-governed structure and scholarly apparatus | exact current regulations, required statements, bibliography style, appendices, and archival export |
